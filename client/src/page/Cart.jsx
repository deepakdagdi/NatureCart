                 ...
                 if(addresses.length > 0)
                     {
                        ...
                        setSelectAddresses(addresses[0])
                 }
            }else{
                toast.error(data.message);
            }
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selectAddresses ? `${selectAddresses.street},${selectAddresses.city},
                        ${selectAddresses.state},${selectAddresses.country}`: "No address found"}</p>
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                {addresses.map((address,index)=>(
                                    <p key={index} onClick={() => {setSelectAddresses(address); setShowAddress(false)}} className="text-gray-500 p-2 hover:bg-gray-100">
